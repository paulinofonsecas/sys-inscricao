      ...
      <div class="row event_box">
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src={{ url("assets/images/course-01.jpg", []) }} alt=""></a>
      ...
      <div class="row">
        <div class="col-lg-6  align-self-center">
          <div class="section-heading">
            ...
            <p>Bem-vindos! Estamos aqui para responder às suas dúvidas e para escutar as suas opiniões. Ficamos felizes em ouvir-lhes e queremos ajudá-los sempre que possível!</p>
          </div>
        </div>
        <div class="col-lg-6">
